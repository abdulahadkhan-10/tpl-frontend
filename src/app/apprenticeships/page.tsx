                    ...
                    >
                      ...
                      <div className="w-24 flex flex-col shrink-0">
                        ...
                        <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                          <div className={`h-full ${colors.bar} transition-all duration-500`} style={{ width: `${progressPct}%` }} />
                        </div>
                      </div>
                    </motion.div>
                  );
              ...
              >
                ...
                {submitted ? (
                  <motion.div 
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="bg-emerald-50/80 border border-emerald-100 rounded-2xl p-5 text-center space-y-4 py-8"
                  >
                    <div className="mx-auto w-12 h-12 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center"><CheckCircle2 size={24} /></div>
