...
export default function GalleriesPage() {
  return (
    <React.Suspense fallback={<div className="min-h-screen bg-slate-50/50 pt-32 pb-12 flex justify-center items-center text-sm font-bold text-slate-400">Loading archives...</div>}>
      <GalleriesContent />
    </React.Suspense>
  );
}
